...
public class DisplayEventMenuAction implements Action {
    ...
    public DisplayEventMenuAction(Scanner scanner, CalendarManager calendarManager, UserManager userManager) {
        this.scanner = scanner;
        this.userManager = userManager;
        this.listAction = new ListAction();

        this.listAction.addAction(new DisplayEventAction(calendarManager));
